    ...
    <div className="w-[600px] h-[45px] bg-[#1a1a1a] border border-[#373737] rounded-xl flex items-center gap-2 mb-2.5 mx-0 py-[24px] px-[8px]">
      ...
      <div className="flex items-center gap-1 px-2 py-1 text-sm">
        {hasSelectedImage ? (
          ...
          <span className="text-orange-400">⚠ Select an image from the board</span>
        )}
      </div>
      ...
      {/* Generate button */}
      <button onClick={handleGenerate} className="flex items-center gap-1 px-2 py-1 text-[#E1FF00] hover:text-white transition-colors shrink-0">
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[30px] h-[30px]">
