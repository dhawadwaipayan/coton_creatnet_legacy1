    ...
    <div className="w-[800px] h-[45px] bg-[#1a1a1a] border border-[#373737] rounded-xl flex items-center gap-2 mb-2.5 mx-0 py-[24px] px-[8px]">
      ...
      <div className="relative" ref={subModeMenuRef}>
        <button
          ...
          className="flex items-center justify-center px-2 py-1 bg-[#212121] hover:bg-[#2a2a2a] text-neutral-400 hover:text-white transition-colors shrink-0 rounded-lg min-w-[80px] h-[28px]"
        >
        ...
        {isSubModeMenuOpen && (
          <div className="absolute bottom-full left-0 mb-2.5 w-full bg-[#212121] border border-[#373737] rounded-lg shadow-lg z-50">
      ...
      <button 
        ...
        disabled={!canGenerate || isLimitReached}
      >
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[30px] h-[30px]">
