...
async function handleGeminiAI(action, data) {
  ...
  // Use the exact prompt structure from original service
  ...
  console.log('[AI Proxy] Final promptText:', finalPromptText);
  console.log('[AI Proxy] Prompt length:', finalPromptText.length);
  ...
  console.log('[AI Proxy] Gemini response received:', {
  ...
  console.log('[AI Proxy] Generated image check:', {
  ...
  if (!generatedImage?.inlineData?.data) {
    console.error('[AI Proxy] No image generated - full response:', JSON.stringify(response, null, 2));
    throw new Error('No image generated by Gemini API');
  }

  // Return in the same format as original service
  return {
    candidates: [{
      content: {
        parts: [{
